...
- 📝 Developing [Markdown Editor](https://github.com/donvito/markdown-editor), a lightweight markdown files editor with AI features (supports local models with Ollama or LMStudio)
