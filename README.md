...
- ⚡ Currently building [AIBackends](https://github.com/donvito/ai-backends), an AI API server with ready-to-use AI features and which can run locally via Ollama and LMStudio.
